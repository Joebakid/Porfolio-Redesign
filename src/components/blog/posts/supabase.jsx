  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-gray-700 leading-8">
        ...
        However, Firebase Storage no longer have free tier, you need a card to access its storage.
      </p>
      ...
      <div className="bg-gray-50 border-l-4 border-gray-900 p-6 my-8 italic text-gray-600 text-xl">
